...
class CategoryItem {
  ...
  const CategoryItem({required this.ru, required this.kk});
...
final List<CategoryItem> categories = [
  CategoryItem(ru: 'Фрукты и овощи', kk: 'Жемістер мен көкөністер'),
  CategoryItem(
  ...
  CategoryItem(ru: 'Молоко', kk: 'Сүт'),
  CategoryItem(ru: 'Мясо, исключая птицу', kk: 'Құс етін қоспағандағы ет'),
  CategoryItem(ru: 'Сыры', kk: 'Ірімшіктер'),
  CategoryItem(ru: 'Питание детское', kk: 'Балалар тағамы'),
  CategoryItem(ru: 'Печенье', kk: 'Печенье'),
  CategoryItem(ru: 'Продовольственные товары', kk: 'Азық-түлік тауарлары'),
  CategoryItem(
    ru: 'Непродовольственные товары',
    kk: 'Азық-түлік емес тауарлар',
  ),
  CategoryItem(ru: 'Основные продукты питания', kk: 'Негізгі тамақ өнімдері'),
];
